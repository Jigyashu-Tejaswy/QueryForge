# DataForge — Distributed SQL Query Engine

> A production-grade distributed SQL engine that processes million-row CSV datasets across parallel worker nodes. Upload a dataset, write SQL, and DataForge distributes execution across 3 workers — returning results faster than any single-machine setup.
>
...
```bash
git clone https://github.com/Jigyashu-Tejaswy/DataForge
cd DataForge
...
*Built by [Jigyashu Tejaswy](https://github.com/Jigyashu-Tejaswy) — B.Tech Mathematics & Scientific Computing, IIITM Gwalior*
